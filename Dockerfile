...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name mysql mysql
...
RUN SECRET_KEY_BASE_DUMMY=1 secret_key_base="secretkey" ./bin/rails assets:precompile
